...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.Reporst_Btn_Text.clicked.connect(self.show_test)
        ...
        # self.ui.Help_Btn.clicked.connect(self.show_report)
        self.ui.Help_Btn_Text.clicked.connect(self.show_report)
