...
"border: 1px solid black;")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1180, 2000))
        ...
        self.tableAverage.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        ...
        self.gridLayout_3.addWidget(self.tableCompare, 1, 0, 1, 1)
