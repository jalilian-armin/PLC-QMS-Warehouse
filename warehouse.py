...
class WarehousePage(QMainWindow, Ui_WarehousePage):
    ...
    def addWarehouse(self):
        ...
        insert_part = "INSERT INTO warehouse (orderdate, category, serial, ordernum, supplier, company, country, operator, currentdate) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
    ...
    def delete_record(self, connection, record_id):
        ...
        cursor.execute("DELETE FROM warehouse WHERE id=%s", (record_id,))
        connection.commit()
